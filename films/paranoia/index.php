...
<head>
    ...
    <title>Paranoïa - Films - Films de Plein Air</title>
        ...
        <div id="main-content" class="container">
            <main class="row">
                <section class="col-12 col-lg-8">
                    <p class="mt-3 mb-3 text-black"><a class="text-black animate-opacity" href="/">Accueil</a> > <a class="text-black animate-opacity" href="/films">Films</a> > Paranoïa</p>

                    <h1 class="mt-5 mb-5 imperial-bold text-black text-center text-md-start">Paranoïa</h1>

                    <div class="row g-4 mb-5">
                        <div class="col-12 col-md-4">
                            <img class="shadow img-fluid rounded-4" src="/images/films/paranoia.jpg" alt="">
                        </div>

                        <div class="col-12 col-md-8">
                            <p class="imperial text-black mb-3 text-center text-md-start">Date de sortie : 11 juillet 2018 / 1h 38min / Thriller</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Réalisateur : Steven Soderbergh</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Avec : Claire Foy, Joshua Leonard, Amy Irving</p>

                            <h2 class="imperial-bold text-black mb-3 text-center text-md-start">Synopsis</h2>
                            <p class="imperial text-black mb-3 text-center text-md-start">Une jeune femme, convaincue d'être harcelée, est enfermée contre son gré dans une institution psychiatrique. Alors même qu'elle tente de convaincre tout le monde qu'elle est en danger, elle commence à se demander si sa peur est fondée ou le fruit de son imagination …</p>
                        </div>
                    </div>

                    <h2 class="imperial-bold text-black mb-4 text-center">Projection le samedi 05 août 2023 à 18h00</h2>
