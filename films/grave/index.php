...
<head>
    ...
    <title>Grave - Films - Films de Plein Air</title>
        ...
        <div id="main-content" class="container">
            <main class="row">
                <section class="col-12 col-lg-8">
                    <p class="mt-3 mb-3 text-black"><a class="text-black animate-opacity" href="/">Accueil</a> > <a class="text-black animate-opacity" href="/films">Films</a> > Grave</p>

                    <h1 class="mt-5 mb-5 imperial-bold text-black text-center text-md-start">Grave</h1>

                    <div class="row g-4 mb-5">
                        <div class="col-12 col-md-4">
                            <img class="shadow img-fluid rounded-4" src="/images/films/grave.jpg" alt="">
                        </div>

                        <div class="col-12 col-md-8">
                            <p class="imperial text-black mb-3 text-center text-md-start">Date de sortie : 15 mars 2017 / 1h 38min / Epouvante-horreur, Drame</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Réalisateur : Julia Ducournau</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Avec : Garance Marillier, Ella Rumpf, Rabah Naït Oufella</p>

                            <h2 class="imperial-bold text-black mb-3 text-center text-md-start">Synopsis</h2>
                            <p class="imperial text-black mb-3 text-center text-md-start">Dans la famille de Justine tout le monde est vétérinaire et végétarien. À 16 ans, elle est une adolescente surdouée sur le point d’intégrer l’école véto où sa sœur ainée est également élève. Mais, à peine installés, le bizutage commence pour les premières années. On force Justine à manger de la viande crue. C’est la première fois de sa vie. Les conséquences ne se font pas attendre. Justine découvre sa vraie nature.</p>
                        </div>
                    </div>

                    <h2 class="imperial-bold text-black mb-4 text-center">Projection le lundi 07 août 2023 à 18h00</h2>
