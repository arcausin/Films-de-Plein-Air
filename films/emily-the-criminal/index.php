...
<head>
    ...
    <title>Emily The Criminal - Films - Films en Plein Air</title>
        ...
        <div id="main-content" class="container">
            <main class="row">
                <section class="col-12 col-lg-8">
                    <p class="mt-3 mb-3 text-black"><a class="text-black animate-opacity" href="/">Accueil</a> > <a class="text-black animate-opacity" href="/films">Films</a> > Emily The Criminal</p>

                    <h1 class="mt-5 mb-5 imperial-bold text-black text-center text-md-start">Emily The Criminal</h1>

                    <div class="row g-4 mb-5">
                        <div class="col-12 col-md-4">
                            <img class="shadow img-fluid rounded-4" src="/images/films/emily_the_criminal.jpg" alt="">
                        </div>

                        <div class="col-12 col-md-8">
                            <p class="imperial text-black mb-3 text-center text-md-start">Date de sortie : 14 novembre 2022 / 1h 34min / Thriller, Comédie dramatique</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Réalisateur : John Patton Ford</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Avec : Aubrey Plaza, Theo Rossi, Jonathan Avigdori</p>

                            <h2 class="imperial-bold text-black mb-3 text-center text-md-start">Synopsis</h2>
                            <p class="imperial text-black mb-3 text-center text-md-start">La chance en berne et croulant sous les dettes, Emily en est à intégrer un réseau d'arnaqueurs à la carte de crédit et plonge peu à peu dans le milieu criminel de Los Angeles, non sans conséquences.</p>
                        </div>
                    </div>

                    <h2 class="imperial-bold text-black mb-4 text-center">Projection le lundi 07 août 2023 à 19h45</h2>
