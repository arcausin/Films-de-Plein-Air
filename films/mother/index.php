...
<head>
    ...
    <title>Mother! - Films - Films en Plein Air</title>
        ...
        <div id="main-content" class="container">
            <main class="row">
                <section class="col-12 col-lg-8">
                    <p class="mt-3 mb-3 text-black"><a class="text-black animate-opacity" href="/">Accueil</a> > <a class="text-black animate-opacity" href="/films">Films</a> > Mother!</p>

                    <h1 class="mt-5 mb-5 imperial-bold text-black text-center text-md-start">Mother!</h1>

                    <div class="row g-4 mb-5">
                        <div class="col-12 col-md-4">
                            <img class="shadow img-fluid rounded-4" src="/images/films/mother.jpg" alt="">
                        </div>

                        <div class="col-12 col-md-8">
                            <p class="imperial text-black mb-3 text-center text-md-start">Date de sortie : 13 septembre 2017 / 2h 02min / Thriller</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Réalisateur : Darren Aronofsky</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Avec : Jennifer Lawrence, Javier Bardem, Ed Harris</p>

                            <h2 class="imperial-bold text-black mb-3 text-center text-md-start">Synopsis</h2>
                            <p class="imperial text-black mb-3 text-center text-md-start">Un couple voit sa relation remise en question par l'arrivée d'invités imprévus, perturbant leur tranquillité.</p>
                        </div>
                    </div>

                    <h2 class="imperial-bold text-black mb-4 text-center">Projection le Mardi 08 août 2023 à 19h15</h2>
