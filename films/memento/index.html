...
<head>
    ...
    <title>Memento - Films - Films de Plein Air</title>
        ...
        <div id="main-content" class="container">
            <main class="row">
                <section class="col-12 col-lg-8">
                    <p class="mt-3 mb-3 text-black"><a class="text-black animate-opacity" href="/">Accueil</a> > <a class="text-black animate-opacity" href="/films">Films</a> > Memento</p>

                    <h1 class="mt-5 mb-5 imperial-bold text-black text-center text-md-start">Memento</h1>

                    <div class="row g-4 mb-5">
                        <div class="col-12 col-md-4">
                            <img class="shadow img-fluid rounded-4" src="/images/films/memento.jpg" alt="">
                        </div>

                        <div class="col-12 col-md-8">
                            <p class="imperial text-black mb-3 text-center text-md-start">Date de sortie : 11 octobre 2000 / 1h 56min / Thriller</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Réalisateur : Christopher Nolan</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Avec : Guy Pearce, Carrie-Anne Moss, Joe Pantoliano</p>

                            <h2 class="imperial-bold text-black mb-3 text-center text-md-start">Synopsis</h2>
                            <p class="imperial text-black mb-3 text-center text-md-start">Leonard n'a qu'une idée en tête : traquer l'homme qui a violé et assassiné sa femme afin de se venger. Sa recherche du meurtrier est rendue plus difficile par le fait qu'il souffre d'une forme rare et incurable d'amnésie. Bien qu'il puisse se souvenir de détails de son passé, il est incapable de savoir ce qu'il a fait dans le quart d'heure précédent, où il se trouve, où il va et pourquoi.</p>
                        </div>
                    </div>

                    <h2 class="imperial-bold text-black mb-4 text-center">Projection le dimanche 06 août 2023 à 21h30</h2>
