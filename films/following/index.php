...
<head>
    ...
    <title>Following - Films - Films en Plein Air</title>
        ...
        <div id="main-content" class="container">
            <main class="row">
                <section class="col-12 col-lg-8">
                    <p class="mt-3 mb-3 text-black"><a class="text-black animate-opacity" href="/">Accueil</a> > <a class="text-black animate-opacity" href="/films">Films</a> > Following</p>

                    <h1 class="mt-5 mb-5 imperial-bold text-black text-center text-md-start">Following</h1>

                    <div class="row g-4 mb-5">
                        <div class="col-12 col-md-4">
                            <img class="shadow img-fluid rounded-4" src="/images/films/following.jpg" alt="">
                        </div>

                        <div class="col-12 col-md-8">
                            <p class="imperial text-black mb-3 text-center text-md-start">Date de sortie : 1 décembre 1999 / 1h 10min / Thriller</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Réalisateur : Christopher Nolan</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Avec : Jeremy Theobald, Alex Haw, Lucy Russell</p>

                            <h2 class="imperial-bold text-black mb-3 text-center text-md-start">Synopsis</h2>
                            <p class="imperial text-black mb-3 text-center text-md-start">Un romancier en herbe est poursuivi par une obsession. Il file des inconnus jusqu'au jour où l'un d'eux, cambrioleur professionnel, l'entraîne dans ses combines.</p>
                        </div>
                    </div>

                    <h2 class="imperial-bold text-black mb-4 text-center">Projection le Mardi 08 août 2023 à 18h00</h2>
