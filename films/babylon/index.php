...
<head>
    ...
    <title>Babylon - Films - Films en Plein Air</title>
        ...
        <div id="main-content" class="container">
            <main class="row">
                <section class="col-12">
                    <p class="mt-3 mb-3 text-black"><a class="text-black animate-opacity" href="/">Accueil</a> > <a class="text-black animate-opacity" href="/films">Films</a> > Babylon</p>

                    <h1 class="mt-5 mb-5 imperial-bold text-black text-center text-md-start">Babylon</h1>

                    <div class="row g-4 mb-5">
                        <div class="col-12 col-md-4">
                            <img class="shadow img-fluid rounded-4" src="/images/films/babylon.jpg" alt="">
                        </div>

                        <div class="col-12 col-md-8">
                            <p class="imperial text-black mb-3 text-center text-md-start">Date de sortie : 18 janvier 2023 / 3h 09min / Historique, Drame</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Réalisateur : Damien Chazelle</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Avec : Brad Pitt, Margot Robbie, Diego Calva</p>

                            <h2 class="imperial-bold text-black mb-3 text-center text-md-start">Synopsis</h2>
                            <p class="imperial text-black mb-3 text-center text-md-start">Los Angeles des années 1920. Récit d'une ambition démesurée et d'excès les plus fous, BABYLON retrace l'ascension et la chute de différents personnages lors de la création d'Hollywood, une ère de décadence et de dépravation sans limites.</p>
                        </div>
                    </div>

                    <h2 class="imperial-bold text-black mb-4 text-center">Projection le lundi 07 août 2023 à 21h30</h2>
