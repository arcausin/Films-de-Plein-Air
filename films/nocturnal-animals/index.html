...
<head>
    ...
    <title>Nocturnal Animals - Films - Films de Plein Air</title>
        ...
        <div id="main-content" class="container">
            <main class="row">
                <section class="col-12 col-lg-8">
                    <p class="mt-3 mb-3 text-black"><a class="text-black animate-opacity" href="/">Accueil</a> > <a class="text-black animate-opacity" href="/films">Films</a> > Nocturnal Animals</p>

                    <h1 class="mt-5 mb-5 imperial-bold text-black text-center text-md-start">Nocturnal Animals</h1>

                    <div class="row g-4 mb-5">
                        <div class="col-12 col-md-4">
                            <img class="shadow img-fluid rounded-4" src="/images/films/nocturnal_animals.jpg" alt="">
                        </div>

                        <div class="col-12 col-md-8">
                            <p class="imperial text-black mb-3 text-center text-md-start">Date de sortie : 04 janvier 2017 / 1h 57min / Drame, Thriller</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Réalisateur : Tom Ford</p>
                            <p class="imperial text-black mb-3 text-center text-md-start">Avec : Amy Adams, Jake Gyllenhaal, Michael Shannon</p>

                            <h2 class="imperial-bold text-black mb-3 text-center text-md-start">Synopsis</h2>
                            <p class="imperial text-black mb-3 text-center text-md-start">Susan Morrow, une galeriste d'art de Los Angeles, s'ennuie dans l'opulence de son existence, délaissée par son riche mari Hutton. Alors que ce dernier s'absente, encore une fois, en voyage d'affaires, Susan reçoit un colis inattendu.</p>
                        </div>
                    </div>

                    <h2 class="imperial-bold text-black mb-4 text-center">Projection le samedi 05 août 2023 à 20h00</h2>
